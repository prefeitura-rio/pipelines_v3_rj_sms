...
def _definir_data_js(driver: Firefox, locator: tuple[str, str], valor: str) -> None:
  ...
  wait_until(
    driver, lambda d: d.find_element(*locator).get_attribute("value").strip() != ""
  )


def set_filters(
  driver: Firefox, opcao_exame: str, data_inicio: str, data_fim: str
) -> None:
